...
function Project() {
 return (
    <Container id="project">
      ...
      <section>
        <ProjectItem 
         img="https://user-images.githubusercontent.com/73802190/143438835-1cae53d3-7707-4de0-9505-31e5941dc405.jpg" title={''} type={''} slug={''}          // title="DH BURGUER"
          // type="This project was developed during the Full-Stack course at Digital House, integration project." 
          // slug={''}          // slug="teste"
        />
        
        <ProjectItem2
         img="https://user-images.githubusercontent.com/73802190/143436963-deaa5d63-08b2-4541-bb94-3ca94c4499a6.jpg" title={''} type={''} slug={''}          // title="IGNEWS - Portal de notícias"
